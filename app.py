...
_TRADE_UNSPLASH_QUERIES = {
    ...
    "hvac":           "hvac air conditioning heating technician",
    "electrician":    "electrician wiring electrical panel",
    "electrical":     "electrician wiring electrical panel",
    "roofer":         "roofing shingles roof repair",
    "roofing":        "roofing shingles roof repair",
    "landscaper":     "landscaping lawn mowing garden",
    "landscaping":    "landscaping lawn mowing garden",
    "painter":        "house painting interior paint roller",
    "painting":       "house painting interior paint roller",
    "concrete":       "concrete driveway patio",
    "excavation":     "excavation equipment digging",
    "contractor":     "home renovation remodeling",
    "house cleaning": "house cleaning maid service sparkling clean home",
    "cleaning":       "house cleaning maid service sparkling clean home",
    "maid":           "house cleaning maid service sparkling home",
    "pest control":   "pest control exterminator spraying home",
    "pest":           "pest control exterminator spraying",
    "carpet":         "carpet cleaning vacuum steam clean",
    "window":         "window cleaning sparkling glass squeegee",
    "pressure":       "pressure washing driveway house exterior clean",
    "junk":           "junk removal truck clean out",
    "moving":         "moving boxes truck relocation",
    "tree":           "tree trimming arborist removal",
    "fence":          "fence installation wood privacy",
    "garage":         "garage door repair installation",
    "gutters":        "gutter cleaning roof gutters",
}
...
def _slack_notify_lead(name: str, phone: str, email: str, business: str):
    ...
    channel = os.environ.get("SLACK_LEADS_CHANNEL", "leads").strip()
    if not token:
        print("[Slack] lead notify skipped — no token")
        return
    text = (
    ...
    try:
        resp = _req.post(
            ...
            data=_json.dumps({"channel": channel, "text": text, "unfurl_links": False}).encode("utf-8"),
            headers={
        ...
        print(f"[Slack] lead notify: {resp.text[:200]}")
    except Exception as e:
